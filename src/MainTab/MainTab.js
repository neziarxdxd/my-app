...
const listDatabase = dataBase.map((listItems) =>  <li>{listItems}</li>);
  return(
    ...
    <div class="grid">
      ...
      <div class="card">        
        <div class="text">
          <div class="title-bar">raizengxd</div>
          <p> <span className="emoji">👩‍💻</span> Hi I'm Raizen Sangalang</p>
          <p><span className="emoji">💻</span> I'm here to help and collab with you</p>
          <p><span className="emoji">🔧 </span>Solve problem and build solution</p>
          <div class="social-media-group">
          <a  rel="noreferrer" target="_blank" href="https://github.com/zenraiching" className="social-icon">
          ...
          <a rel="noreferrer" target="_blank" href="https://www.linkedin.com/in/raizen-john-sangalang-744a85194/" className="social-icon">
    ...
    <div class="grid-2" >
      <div class="card">
        <div class="text">
          ...
          <p>building some solution for businesses and other problem that we encounter</p>
         
      </div>
      </div>
      <div class="card">
        <div class="text">
          <div class="card-head">LOGIC</div>
          <p>Passion for studying about algorithms and solving problem that can enhance logic and solving real problem by the other people</p>
         
      </div>
      </div>
      <div class="card">
        <div class="text">
          <div class="card-head">WEB APP</div>
          <p>creating web app to make everything easy to access</p>
         
      </div>
      </div>
      <div class="card">
        <div class="text">
          <div class="card-head">MENTORING</div>
          <p>Sharing the knowledge that I've learned throughout my programming years I believe that learning shouldn't stop to me</p>
